...
function Footer() {
  return (
    <footer className="text-white">
      ...
      <div className="flex justify-center my-5 gap-5 text-[22px]">
        <span className="bg-black p-3 rounded-full hover:cursor-pointer hover:text-[#0866FF] duration-200">
          <FaFacebookF />
        </span>
        <span className="bg-black p-3 rounded-full hover:cursor-pointer hover:text-[#F73A22] duration-200">
          <FaInstagram />
        </span>
        <span className="bg-black p-3 rounded-full hover:cursor-pointer hover:text-[#1DA1F2] duration-200">
          <FaTwitter />
        </span>
        <span className="bg-black p-3 rounded-full hover:cursor-pointer hover:text-[#0864C0] duration-200">
          <FaLinkedin />
        </span>
      </div>
    </footer>
